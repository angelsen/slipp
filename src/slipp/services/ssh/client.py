...
from slipp.services.ssh.log import (
    log_ssh_call,
    log_stream_end,
    log_stream_line,
    log_stream_start,
...
class SSHService:
    ...
    def execute(self, command: str, stdin_data: str | None = None) -> SSHResult:
        ...
        try:
            ...
            log_ssh_call(self.config, command, result)
            return result
        finally:
            stdin.close()
            stdout.close()
