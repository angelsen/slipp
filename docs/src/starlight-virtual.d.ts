...
declare module "virtual:starlight/collection-config" {
  export const collections:
    | import("astro:content").ContentConfig["collections"]
    | undefined;
}

declare module "virtual:starlight/route-middleware" {
  export const routeMiddleware: Array<
    import("@astrojs/starlight/route-data").RouteMiddlewareHandler
  >;
}
...
declare module "virtual:starlight/pagefind-config" {
  export const pagefindUserConfig: Partial<
    Extract<
      import("@astrojs/starlight/types").StarlightConfig["pagefind"],
      object
    >
  >;
}
